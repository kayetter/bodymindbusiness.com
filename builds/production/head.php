...
<head>
    ...
    <meta property="og:image"  content="https://bodymindbusiness.com/images/BMB_Square1-1cafc627cb.png" />

    <!-------twitter OG content------------->
    <meta name="twitter:site" content="@bodymindbusines" />
    <meta name="twitter:creator" content="@thedameranch" />
    <meta property="twitter:image"  content="https://bodymindbusiness.com/images/BMB_WebBannerHead_TC-b9a3bba0c1.png" />
    ...
    <meta name="twitter:card" content="summary" />
        ...
        <!--        favicon links                        -->
    <link rel="shortcut icon" href="images/favicon-67da15ea13.ico" type="image/x-icon">
    <link rel="icon" href="images/favicon-67da15ea13.ico" type="image/x-icon">

        <!-------------Stylesheet Links---------------->
        <link rel="stylesheet" href="css/style-474293a531.css">
